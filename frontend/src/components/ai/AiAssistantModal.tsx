          ...
          <section className="flex h-full flex-col px-5 pb-6 pt-12">
            ...
            <SheetHeader className="text-left">
              ...
              <SheetDescription className="leading-6">
                Este asistente busca información en los recursos revisados de Tinkuy. No diagnostica ni reemplaza una consulta profesional.
              </SheetDescription>
            </SheetHeader>
          ...
          <section className="flex h-full min-h-0 flex-col">
            <header className="border-b border-border px-5 pb-4 pt-10">
              <div className="flex items-center gap-3 pr-8">
                ...
                <div>
                  <h2 className="font-semibold text-foreground">Asistente Tinkuy</h2>
